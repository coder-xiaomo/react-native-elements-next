...
```bash
npm install @rneuinext/themed @rneuinext/base
```
...
| ----------------- | -------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------- |
| **@rneuinext/base**   | [![badge](https://img.shields.io/npm/v/@rneuinext/base.svg?style=flat-square-square)](https://www.npmjs.com/package/@rneuinext/base)     | ![npm](https://img.shields.io/npm/dm/@rneuinext/base?style=flat-square-square)   |
| **@rneuinext/themed** | [![badge](https://img.shields.io/npm/v/@rneuinext/themed.svg?style=flat-square-square)](https://www.npmjs.com/package/@rneuinext/themed) | ![npm](https://img.shields.io/npm/dm/@rneuinext/themed?style=flat-square-square) |
...
```tsx
import { Button } from '@rneuinext/base';
...
[React Native Elements App](https://expo.dev/@rneuinext/react-native-elements)

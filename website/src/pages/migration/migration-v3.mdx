...
# or with yarn
yarn add @rneuinext/base @rneuinext/themed
```

You can also make `alias` for package to help you with migration.

```bash
yarn add react-native-elements@npm:@rneuinext/themed
```
...
+ import { lightColors, darkColors } from '@rneuinext/themed'
```
...
```jsx
import { ThemeProvider, Button, createTheme } from '@rneuinext/themed';
...
```jsx
import { createTheme } from '@rneuinext/themed';

...
```bash
yarn add @rneuinext/themed @rneuinext/base
```
...
```bash
npm install @rneuinext/base@edge @rneuinext/themed@edge
```
...
```bash
yarn add @rneuinext/base@edge @rneuinext/themed@edge
```
...
```bash
# @rneuinext/base
yarn add @rneuinext/base@github:react-native-elements/react-native-elements#base

# @rneuinext/themed
yarn add @rneuinext/themed@github:react-native-elements/react-native-elements#themed
```
...
```bash
npx create-expo-app --template @rneuinext/template
```
...
```bash
npx create-expo-app --template @rneuinext/template@edge
```
...
```bash
yarn add  @rneuinext/base @rneuinext/themed react-native-web react-native-vector-icons
```
...
module.exports = override(
  ...
  babelInclude([
    path.resolve(__dirname, 'node_modules/@rneuinext/base'),
    path.resolve(__dirname, 'node_modules/@rneuinext/themed'),
